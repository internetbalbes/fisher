...
@export var checkbutton_tutorial: CheckButton
...
func _ready() -> void:
	if config.load("res://settings.cfg") == OK:
		...
		checkbutton_tutorial.button_pressed = config.get_value("common", "tutorial", 0)
...
func _on_menubutton_back_pressed() -> void:
	...
	config.set_value("common", "tutorial", checkbutton_tutorial.button_pressed)
